...
def plot_8lm_patches():
    """Plot the 8-SM + view_finder visualization for figure 6.

    Uses data from the experiment `fig6_visualize_8lm_patches` defined in
    ...
    Output is saved to `DMC_ANALYSIS_DIR/fig6/8lm_patches`.
    ...
    experiment_dir = VISUALIZATION_RESULTS_DIR / "fig6_visualize_8lm_patches"
